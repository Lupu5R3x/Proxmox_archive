#!/usr/bin/env bash
source <(curl -s https://raw.githubusercontent.com/lupu5R3x/Proxmox_archive/main/misc/build.func)
...
if [[ ! -f /etc/apt/sources.list.d/plex.list ]]; then msg_error "No ${APP} Installation Found!"; exit; fi
